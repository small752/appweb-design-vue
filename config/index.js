...
module.exports = {
  ...
  build: {
    ...
    index: path.resolve(__dirname, '../dist/periodical/index.html'),

    // Paths
    assetsRoot: path.resolve(__dirname, '../dist/periodical/resources'),
    assetsSubDirectory: 'static',
    assetsPublicPath: '/dd/app/periodical/resources/',
